 ...
 * @author xuliang
 * @date:2020-04-14
 * @desc:ConcurrentHashMap实现缓存，（缓存数量，过期时间，过期缓存清理）
 */
public class LocalCacheUtils {
     ...
     * 时间一分钟
     */
    public static final Long ONE_MINUTE = 2 * 1000L;

    /**
     * 对象缓存时间 2分钟
     */
    public static final Long TIMEOUT_MINUTE = 3 * 1000L;
    /**
     * 缓存对象
     */
...
class CleanTimeOutThread implements Runnable {
    ...
    public void run() {
        ...
        while (true) {
            log.info("clean local cache thread run ");
